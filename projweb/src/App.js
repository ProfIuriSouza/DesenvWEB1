        ...
        <div className='backgroud font-text'>
            ...
            <div className='container mb-4'>
                ...
                <div className='row'>
                    ...
                    <div className="col-4">
                    <button onClick={findTask} className="btn btn-info mx-3 text-light">
                        <i className="bi bi-search"></i>
                    </button>

                    <button onClick={addTask} className="btn btn-secondary mt-3 text-light" disabled={!isLogged}>
                        <i className="bi bi-plus-square-dotted">
                        <span>Adicionar</span>
                        </i>
                    </button>
                    
                    <button onClick={findCategory} className="btn btn-info text-light">
                        <i className="bi bi-search"></i>
                    </button>
                    </div>
                </div>
